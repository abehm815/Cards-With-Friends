...
public class StringReqActivity extends AppCompatActivity {
    ...
    private void makeStringReq() {
        ...
        int HTTP_method = Request.Method.GET;
        String URL = URL_STRING_REQ;

        // Create response listener for stringRequest object
        ...
        //Create error listener for stringRequest Object
        ...
        //Create new stringrequest object and overide some methods

        StringRequest stringRequest = new StringRequest(HTTP_method, URL, responseListener, errorListener){
            @Override
